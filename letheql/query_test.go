...
func Test_Query_Success(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"01": {query: `pod{namespace="namespace01"}`,
			want: QueryData{ResultType: "logs", Logs: []logStore.LogLine{
				logStore.PodLog{Time: "2009-11-10T$2:59:00Z", Namespace: "namespace01", Pod: "nginx-deployment-75675f5897-7ci7o", Container: "nginx", Log: "2009-11-10T22:59:00.000000Z[namespace01|ngin$-deployment-75675f5897-7ci7o|nginx] lerom ipsum"},
		...
		"04": {query: `pod{namespace="namespace01",pod="nginx-*"}`,
			want: QueryData{ResultType: "logs", Logs: []logStore.LogLine{}}}, //{"2009-11-10T21:00:00.000000Z[namespace01|nginx-deployment-75675f5897-7ci7o|nginx] hello world", "2009-11-10T21:01:00.000000Z[namespace01|nginx-deployment-75675f5897-7ci7o|nginx] hello world", "2009-11-10T21:02:00.000000Z[namespace01|nginx-deployment-75675f5897-7ci7o|nginx] hello world", "2009-11-10T22:58:00.000000Z[namespace01|nginx-deployment-75675f5897-7ci7o|sidecar] hello from sidecar", "2009-11-10T22:58:00.000000Z[namespace01|nginx-deployment-75675f5897-7ci7o|sidecar] lerom from sidecar", "2009-11-10T22:58:00.000000Z[namespace01|nginx-deployment-75675f5897-7ci7o|sidecar] hello from sidecar", "2009-11-10T22:59:00.000000Z[namespace01|nginx-deployment-75675f5897-7ci7o|nginx] lerom ipsum", "2009-11-10T22:59:00.000000Z[namespace01|nginx-deployment-75675f5897-7ci7o|nginx] hello world"}, Scalar: 0}},
		...
		"10": {query: `count_over_time(pod{namespace="namespace01",pod="nginx-*"}[3m])`,
			want: QueryData{ResultType: "scalar", Logs: []logStore.LogLine{}}}, //(nil), Scalar: 5}},
		"11": {query: `1`,
			want: QueryData{ResultType: ValueTypeScalar, Logs: nil, Scalar: 1}},
		"12": {query: `count_over_time(pod{}[3m])`,
			want: QueryData{ResultType: "scalar", Logs: []logStore.LogLine{}}}, //(nil), Scalar: 20}},
		...
		"17": {query: `pod{namespace="namespace01"} != hello`,
			want: QueryData{ResultType: "logs", Logs: []logStore.LogLine{}}}, //{"2009-11-10T22:58:00.000000Z[namespace01|nginx-deployment-75675f5897-7ci7o|sidecar] lerom from sidecar", "2009-11-10T22:59:00.000000Z[namespace01|nginx-deployment-75675f5897-7ci7o|nginx] lerom ipsum"}, Scalar: 0}},
		"18": {query: `pod{namespace="namespace01"} |~ (.ro.*o)`,
			want: QueryData{ResultType: ValueTypeLogs, Logs: []logStore.LogLine{}}}, //{"2009-11-10T22:58:00.000000Z[namespace01|nginx-deployment-75675f5897-7ci7o|sidecar] lerom from sidecar"}, Scalar: 0}},
